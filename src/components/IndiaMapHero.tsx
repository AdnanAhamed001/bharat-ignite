...
const startups: StartupSpot[] = [
  { name: "Alchemyst AI", city: "Bengaluru", x: 43, y: 76, logo: alchemystLogo, founder: alchemystFounder },
  { name: "NuGenomics", city: "Bengaluru", x: 45, y: 75, logo: nugenomicsLogo, founder: nugenomicsFounder },
  { name: "Bioreform", city: "Hyderabad", x: 46, y: 63, logo: bioreformLogo, founder: bioreformFounder },
  ...
  { name: "ChocoChi", city: "Kozhikode", x: 36, y: 80, logo: chocochiLogo, founder: chocochiFounder },
  ...
  { name: "Crink", city: "Kochi", x: 37, y: 82, logo: crinkLogo, founder: crinkFounder },
